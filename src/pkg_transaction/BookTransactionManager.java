...
public class BookTransactionManager {
	...
	public boolean issueBook(int rollNo, int isbn) {
		...
		BookTransaction book_transaction = new  BookTransaction (isbn,rollNo,issue_date,null, issue_date, issue_date);
	...
	public void writeToFile() {
		try {
			...
			oos_book_transaction.writeObject(book_transaction_file);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
